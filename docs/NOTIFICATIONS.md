...
absence, retard, absence excusée (Phase 4), notes et annonces.
...
frontend) : les server actions `lib/actions/attendance.ts` / `grades` /
`announcements` insèrent les lignes.
...
- **E2E** : `tests/e2e/attendance.spec.ts` (page notifications).
