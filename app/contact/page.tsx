...
export default function ContactPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-xl flex-1 px-4 py-12">
      ...
      <h1 className="mt-8 text-2xl font-bold">Contactez-nous</h1>
      <p className="mt-2 text-muted-foreground">
        Une question sur les tarifs ou la mise en place ? Notre équipe vous répond.
      </p>
      ...
      <form onSubmit={onSubmit} className="mt-6 space-y-4">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <div className="space-y-1.5">
            ...
            <Input id="school_name" name="school_name" placeholder="Nom de l'école" />
          </div>
        </div>
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div className="space-y-1.5">
        ...
        <div className="space-y-1.5">
          ...
          <Textarea id="message" name="message" rows={4} placeholder="Votre demande…" />
        </div>
